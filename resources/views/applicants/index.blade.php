    ...
    <form method="post" action="">
        ...
        <div class="form-group">
            ...
            <select class="form-control" id="ltype" name="ltype" tabindex="-1" >
                ...
                <option value="Agricusltural Sector Investment" @if (old('ltype') == "Agricusltural Sector Investment") {{ 'selected' }} @endif>Agricusltural Sector Investment</option>
